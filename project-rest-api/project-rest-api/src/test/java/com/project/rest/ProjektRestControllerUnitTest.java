...
public class ProjektRestControllerUnitTest {
    ...
    void getProject_whenValidId_shouldReturnGivenProject() {
        ...
        ResponseEntity<Projekt> responseEntity = projektRestController.getProjekt(projekt.getProjektId());
    ...
    void createProject_whenValidData_shouldCreateProject() {
        ...
        ResponseEntity<Void> responseEntity = projektRestController.createProjekt(projekt);
    ...
    void updateProject_whenValidData_shouldUpdateProject() {
        ...
        ResponseEntity<Void> responseEntity = projektRestController.updateProjekt(projekt, projekt.getProjektId());
    ...
    void deleteProject_whenValidId_shouldDeleteProject() {
        ...
        ResponseEntity<Void> responseEntity = projektRestController.deleteProjekt(projekt.getProjektId());
